...
def show3D_norm_pose(channels, ax, lcolor="#3498db", rcolor="#e74c3c", add_labels=False): # blue, orange
  """
  Visualize a 3d skeleton
  Args
  ...
  #add hip
  hip_coord = np.zeros([1, 3])
  vals = np.insert(vals,0,hip_coord, axis= 0)
...
def show2D_norm_pose(channels, ax, lcolor="#3498db", rcolor="#e74c3c", add_labels=False):
  ...
  I   = np.array([0,1,2,0,4,5,0,7,8,8,10,11,8,14,15]) # start points
